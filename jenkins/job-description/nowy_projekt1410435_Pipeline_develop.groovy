...
def job_config = [
        job: [
                name: "nowy_projekt1410435_Pipeline_develop"
        ],
        git: [
                branch: "feature-1665745620015"
        ]
]
...
def customLib = library identifier: 'nowy_projekt1410435_JSL@develop', retriever: modernSCM(
  [\$class: 'GitSCMSource',
   remote: 'https://github.developer.allianz.io/jarro06/nowy_projekt1410435_lib.git',
   credentialsId: 'git-token-credentials']) 
...
def jslCustom     = customLib.de.allianz.nowy_projekt1410435.new()
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                echo "checkout"
                script {
                    jslGit.checkout( config, "JEQP", "nowy_projekt1410435_Pipeline_develop", "feature-1665745620015")
                }
            }    
        }
        stage('Build') {
